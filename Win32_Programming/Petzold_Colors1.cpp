/*
 * @brief: 		Program having 3 scroll bars(page no. 312 in Charle's Petzold)
 * @details:	This program creates 3 scroll bars on the left half of window & 
 *				displays respective colors as per set RGB values on 
